...
flags.DEFINE_integer('hidden1', 48, 'Number of units in hidden layer 1.(sc)')
flags.DEFINE_integer('hidden2', 32, 'Number of units in hidden layer 2.(fc)')
flags.DEFINE_integer('hidden3', 48, 'Number of units in hidden layer 3.(lstm)')
...
flags.DEFINE_integer('hidden7', 16, 'Number of units in hidden layer 7.(dis_lstm)')
