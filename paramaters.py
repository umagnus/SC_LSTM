...
flags.DEFINE_integer('pre_epochs', 5, 'Number of epochs to pre-train')
flags.DEFINE_integer('sub_epochs', 20, 'Number of epochs to sub-train')
...
flags.DEFINE_float('lamda', 0.5, 'weight of lamda')
flags.DEFINE_float('weight_decay', 0., 'Weight for L2 loss on embedding matrix.')
flags.DEFINE_float('dropout', 0., 'Dropout rate (1 - keep probability).')
flags.DEFINE_integer('windows_size', 20, 'Length of time series windows')
flags.DEFINE_integer('pred_size', 5, 'Length of time series prediction windows')
